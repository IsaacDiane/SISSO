...
if(rung==0) then
 ...
 if(mpirank/=0) then
     ...
     write(*,*) "nfpcore_this(1)= ",nfpcore_this(1)," k= ",ntot+nf(rung)
 end if
end if
...
!open(888,file='name_test',status='replace')
!do i=1,nfpcore_this(1)
!	write(888,'(2a,f12.4)') trim(name_select(i))
!end do
	
!open(999,file='feature_test',status='replace')
!do i=1,sum(nsample)
!	write(999,*)  trainy_c(i),f_select(i,:nfpcore_this(1))
!end do
...
!   end if
   ...
   if(ptype==1) then
      do i=1,nsis(iFCDI)
      	!write(*,*) "======================================================================="
      	!write(*,*) "sisfeat is ",sisfeat(:,:) ," size is ",size(sisfeat,1),size(sisfeat,2)
...
!write(*,*)"feat size is ",size(feat,1)," and ",size(feat,2)
!write(*,*)"iter_sis_p start1"
...
!write(*,*)"iter_sis_p start2"
i=0
do while(i<subs_sis(iFCDI) .and. any(pavailable))
!write(*,*)"iter_sis_p start3"
     ! get the scores
     if(ptype==1) then
     !write(*,*)"nfpcore_this ",nfpcore_this
...
if(ptype==1) then  
   do j=1,ntask
       ...
       mm2=sum(nsample(:j))
       !write(*,*) "====================================mm1,mm2=========================================="
       !write(*,*) "mm1 = ",mm1,", mm2 = ",mm2,", nsample(:j) = ",nsample(:j)
       !write(*,*) "====================================end=============================================="
       ...
       !write(*,*) "====================================sdfeat=========================================="
       !write(*,*) "sdfeat = ",sdfeat(mm1:mm2),", yyy = ",yyy(mm1:mm2),", feat = ",feat(mm1:mm2)
